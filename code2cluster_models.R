...
for(i in 1:length(unique(mod_data$id))){
  ...
  mu03s <- c(hmm_2st_0cov$mle$step["mean",1], 
             hmm_2st_0cov$mle$step["mean",2], 
             hmm_2st_0cov$mle$step["mean",2]*2) 
  
  sigma03s <- c(hmm_2st_0cov$mle$step["sd",1],
                hmm_2st_0cov$mle$step["sd",2],
                hmm_2st_0cov$mle$step["sd",2]*2) 
  
  kappa03s <- c(hmm_2st_0cov$mle$angle["concentration",1],
                hmm_2st_0cov$mle$angle["concentration",2],
                hmm_2st_0cov$mle$angle["concentration",2]*10)
  ...
  mu04s <- c(hmm_2st_0cov$mle$step["mean",1], 
             hmm_2st_0cov$mle$step["mean",2], 
             hmm_2st_0cov$mle$step["mean",2]*2,
             hmm_2st_0cov$mle$step["mean",2]*.5) 
  
  sigma04s <- c(hmm_2st_0cov$mle$step["sd",1],
                hmm_2st_0cov$mle$step["sd",2],
                hmm_2st_0cov$mle$step["sd",2]*2,
                hmm_2st_0cov$mle$step["sd",2]*.5) 
  
  kappa04s <- c(hmm_2st_0cov$mle$angle["concentration",1],
                hmm_2st_0cov$mle$angle["concentration",2],
                hmm_2st_0cov$mle$angle["concentration",2]*10,
                hmm_2st_0cov$mle$angle["concentration",2]*.5)
  ...
  mu06s <- c(hmm_2st_0cov$mle$step["mean",1], 
             hmm_2st_0cov$mle$step["mean",2], 
             hmm_2st_0cov$mle$step["mean",2]*2,
             hmm_2st_0cov$mle$step["mean",2]*.5,
             hmm_2st_0cov$mle$step["mean",1]*2,
             hmm_2st_0cov$mle$step["mean",1]*.5) 
  
  sigma06s <- c(hmm_2st_0cov$mle$step["sd",1],
                hmm_2st_0cov$mle$step["sd",2],
                hmm_2st_0cov$mle$step["sd",2]*2,
                hmm_2st_0cov$mle$step["sd",2]*.5,
                hmm_2st_0cov$mle$step["sd",1]*2,
                hmm_2st_0cov$mle$step["sd",1]*.5) 
  
  kappa06s <- c(hmm_2st_0cov$mle$angle["concentration",1],
                hmm_2st_0cov$mle$angle["concentration",2],
                hmm_2st_0cov$mle$angle["concentration",2]*10,
                hmm_2st_0cov$mle$angle["concentration",2]*.5,
                hmm_2st_0cov$mle$angle["concentration",1]*10,
                hmm_2st_0cov$mle$angle["concentration",1]*.5)
  ...
  fit_mods <- list(hmm_2st, hmm_3st, hmm_4st, hmm_6st,
...
sapply(fit_mods, AIC)
AICweights(hmm_2st, hmm_3st, hmm_4st, hmm_6st,
           cov_2st_cover, cov_3st_cover, cov_4st_cover,
           cov_2st_fence, cov_3st_fence, cov_4st_fence,
           cov_2st_road, cov_3st_road, cov_4st_road,
           cov_2st_cov_fen, cov_3st_cov_fen, cov_4st_cov_fen,
